...
exports.distributeNft = exports.getDistributeNftInstructionDataSerializer = void 0;
const umi_1 = require("@metaplex-foundation/umi");
const serializers_1 = require("@metaplex-foundation/umi/serializers");
const shared_1 = require("../shared");
function getDistributeNftInstructionDataSerializer(_context = {}) {
    return (0, serializers_1.mapSerializer)((0, serializers_1.struct)([
        ['discriminator', (0, serializers_1.array)((0, serializers_1.u8)(), { size: 8 })],
        ['distributeForMint', (0, serializers_1.bool)()],
    ], { description: 'DistributeNftInstructionData' }), (value) => ({
        ...value,
        discriminator: [108, 240, 68, 81, 144, 83, 58, 153],
    }));
}
exports.getDistributeNftInstructionDataSerializer = getDistributeNftInstructionDataSerializer;
// Instruction.
function distributeNft(context, input) {
    const signers = [];
    const keys = [];
    // Program ID.
    ...
    const resolvedAccounts = {
        ...
        membershipKey: [input.membershipKey, false],
    ...
    (0, shared_1.addAccountMeta)(keys, signers, resolvedAccounts.membershipKey, false);
    ...
    // Data.
    const data = getDistributeNftInstructionDataSerializer().serialize(resolvedArgs);
...
exports.distributeNft = distributeNft;
//# sourceMappingURL=distributeNft.js.map