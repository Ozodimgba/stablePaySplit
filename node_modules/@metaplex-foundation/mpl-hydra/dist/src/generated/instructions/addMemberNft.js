...
exports.addMemberNft = exports.getAddMemberNftInstructionDataSerializer = void 0;
const umi_1 = require("@metaplex-foundation/umi");
const serializers_1 = require("@metaplex-foundation/umi/serializers");
const shared_1 = require("../shared");
function getAddMemberNftInstructionDataSerializer(_context = {}) {
    return (0, serializers_1.mapSerializer)((0, serializers_1.struct)([
        ['discriminator', (0, serializers_1.array)((0, serializers_1.u8)(), { size: 8 })],
        ['shares', (0, serializers_1.u64)()],
    ], { description: 'AddMemberNftInstructionData' }), (value) => ({ ...value, discriminator: [92, 255, 105, 209, 25, 41, 3, 7] }));
}
exports.getAddMemberNftInstructionDataSerializer = getAddMemberNftInstructionDataSerializer;
// Instruction.
function addMemberNft(context, input) {
    const signers = [];
    const keys = [];
    // Program ID.
    ...
    // Data.
    const data = getAddMemberNftInstructionDataSerializer().serialize(resolvedArgs);
...
exports.addMemberNft = addMemberNft;
//# sourceMappingURL=addMemberNft.js.map