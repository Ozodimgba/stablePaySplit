...
exports.setForTokenMemberStake = exports.getSetForTokenMemberStakeInstructionDataSerializer = void 0;
const umi_1 = require("@metaplex-foundation/umi");
const serializers_1 = require("@metaplex-foundation/umi/serializers");
const shared_1 = require("../shared");
function getSetForTokenMemberStakeInstructionDataSerializer(_context = {}) {
    return (0, serializers_1.mapSerializer)((0, serializers_1.struct)([
        ['discriminator', (0, serializers_1.array)((0, serializers_1.u8)(), { size: 8 })],
        ['shares', (0, serializers_1.u64)()],
    ], { description: 'SetForTokenMemberStakeInstructionData' }), (value) => ({ ...value, discriminator: [210, 40, 6, 254, 2, 80, 154, 109] }));
}
exports.getSetForTokenMemberStakeInstructionDataSerializer = getSetForTokenMemberStakeInstructionDataSerializer;
// Instruction.
function setForTokenMemberStake(context, input) {
    const signers = [];
    const keys = [];
    // Program ID.
    ...
    // Data.
    const data = getSetForTokenMemberStakeInstructionDataSerializer().serialize(resolvedArgs);
...
exports.setForTokenMemberStake = setForTokenMemberStake;
//# sourceMappingURL=setForTokenMemberStake.js.map