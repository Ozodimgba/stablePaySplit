...
exports.setTokenMemberStake = exports.getSetTokenMemberStakeInstructionDataSerializer = void 0;
const umi_1 = require("@metaplex-foundation/umi");
const serializers_1 = require("@metaplex-foundation/umi/serializers");
const shared_1 = require("../shared");
function getSetTokenMemberStakeInstructionDataSerializer(_context = {}) {
    return (0, serializers_1.mapSerializer)((0, serializers_1.struct)([
        ['discriminator', (0, serializers_1.array)((0, serializers_1.u8)(), { size: 8 })],
        ['shares', (0, serializers_1.u64)()],
    ], { description: 'SetTokenMemberStakeInstructionData' }), (value) => ({
        ...value,
        discriminator: [167, 29, 12, 30, 44, 193, 249, 142],
    }));
}
exports.getSetTokenMemberStakeInstructionDataSerializer = getSetTokenMemberStakeInstructionDataSerializer;
// Instruction.
function setTokenMemberStake(context, input) {
    const signers = [];
    const keys = [];
    // Program ID.
    ...
    // Data.
    const data = getSetTokenMemberStakeInstructionDataSerializer().serialize(resolvedArgs);
...
exports.setTokenMemberStake = setTokenMemberStake;
//# sourceMappingURL=setTokenMemberStake.js.map