...
function getSignMetadataInstructionDataSerializer(_context = {}) {
    return (0, serializers_1.mapSerializer)((0, serializers_1.struct)([['discriminator', (0, serializers_1.array)((0, serializers_1.u8)(), { size: 8 })]], { description: 'SignMetadataInstructionData' }), (value) => ({ ...value, discriminator: [188, 67, 163, 49, 0, 150, 63, 89] }));
}
...
function signMetadata(context, input) {
    ...
    const resolvedAccounts = {
        ...
        holdingAccount: [input.holdingAccount, false],
